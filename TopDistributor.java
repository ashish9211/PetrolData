...
public class TopDistributor {
	...
	static class MyMapper extends Mapper<LongWritable,Text,Text,DoubleWritable>
	{
		public void map(LongWritable key,Text Value,Context context) throws IOException, InterruptedException
		{
			...
			context.write(new Text(str[0]),new DoubleWritable(Double.parseDouble(str[5])));
		}
	}
	...
	Job job=Job.getInstance(conf, "TopDistributor");
	job.setJarByClass(TopDistributor.class);
